  ...
  render() {
    ...
    return (
      <Banner disbaled index={index ? 1 : 0} className={styles.view}>
        <section className="page-view">
          ...
          <div className={styles.solutions}>
            ...
            <div className={styles.solutionsContent}>
              <div className={styles.solutionBlock} onClick={this.handleClick( 1 )}>
                <h2>智<br />慧<br />园<br />区</h2>
              </div>
              <div className={styles.solutionBlock} onClick={this.handleClick( 2 )}>
                <h2>智<br />慧<br />校<br />园</h2>
              </div>
              <div className={styles.solutionBlock} onClick={this.handleClick( 3 )}>
                <h2>智<br />慧<br />建<br />筑</h2>
              </div>
              <div className={styles.solutionBlock} onClick={this.handleClick( 4 )}>
        ...
        {index === 1 ? (
          <section className={classnames( 'page-view', styles.block )}>
            <div className="page-view-bg" style={{ backgroundImage: `url(${banner})` }} />
