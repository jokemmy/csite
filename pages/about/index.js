    ...
    return (
      <Fragment>
        <section className="page-banner page-section">
          <div className={classnames( styles.aboutBlock,  styles.aboutBlockImage, styles.aboutBlockFull )} style={{ backgroundImage: `url(${banner1})` }}>
        ...
        <div className={classnames( styles.aboutBlockImage, styles.dark )} style={{ padding: 0, backgroundImage: `url(${banner2})` }}>
          <section className="page-block" style={{ minHeight: 300, paddingTop: 0 }}>
            <div className={styles.aboutBlockContent}>
              <div className="page-content">
          ...
          <section className="page-block-image">
