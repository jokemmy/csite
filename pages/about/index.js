      ...
      <>
        ...
        <section className={classnames( styles.aboutBlock, styles.aboutBannerBlock )}>
          ...
          <div className="page-content">
            ...
            <p>
              以欣动科技自主研发的Mammoth平台为核心，采用应用支撑平台、数据中心平台、物联感知平台构建起三级平台，
        ...
        <section className={styles.aboutBlock} style={{ backgroundColor: themeVariables['@gray-3'] }}>
          <div className="page-content">
            ...
            <p>
              我们拥有专业系统集成服务团队，可为客户提供多场景、全周期、一体化能源管理系统解决方案。
              为客户提供专业技术支持与系统托管服务，助力系统稳定运行，为节能诊断、节能审计夯实数据基础。
              以数据为支撑，围绕设备系统开展诊断、调试、改造与优化，并面向管理人员提供汇报、培训及管理支撑服务，
              协助客户改善能耗与品质相关问题，搭建长效预防管理机制，助力项目可持续绿色运营。
            </p>
        ...
        <section className={classnames( styles.aboutBlock, styles.aboutBannerBlock )}>
          ...
          <div className="page-content">
            ...
            <p>
              确保能源使用安全；提供高稳定性的产品和解决方案；提供简洁方便的解决方案，帮助客户提高能效管理和过程效率；融合信息技术和运营技术，帮助客户实现更好的的商业结果；以能源为切入，实现资源的可持续；
            </p>
